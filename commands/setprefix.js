...
module.exports.run = async (client,message,args) => {
  ...
  if(!message.member.hasPermission("VIEW_AUDIT_LOG"))return message.channel.send("**:warning: Hey, `" + message.member.displayName + "` You Do Not Have Enough Perms To SetPrefix or You Need `View Audit Log/Staff Team` Role :warning**");
