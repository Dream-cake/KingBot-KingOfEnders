...
module.exports.run = async (bot, message, args) => {
      if(message.author.id !== "412374698987487242") return message.channel.send("**:warning: Hey, `" + message.member.displayName + "` You Can't Restart Me Only The `BotOwner` Can :warning:**")
